...
bool Par1Repairer::AllocateBuffers(size_t memorylimit)
{
  ...
  if (blocksize * verifylist.size() > memorylimit)
  {
    ...
    chunksize = std::max<size_t>(4, ~3 & (memorylimit / verifylist.size()));
  }
  else
  {
