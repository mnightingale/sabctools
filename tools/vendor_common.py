...
Both vendored trees - src/par2/ and src/rapidyenc/ - are snapshots of an upstream
repository at a pinned commit, built by their own CMake, and carrying local patches only
where a CPython extension genuinely needs something different from a standalone binary.
"""
